...
public class ProjectsApp {
		...
		while (!done) {
			try {
				...
				case 5:
					...
					break;
				default:
					System.out.println("\n" + selection + " isn't a valid selection, try again");
					break;
				}
	...
	private void deleteProject() {
		listProjects();
		Integer deleteId = getIntInput("Enter the ID of the project to delete");
		projectService.deleteProject(deleteId);
		System.out.println("Project " + deleteId + " was deleted successfully");
		if(Objects.nonNull(curProject) && curProject.getProjectId().equals(deleteId)) {
			curProject = null;
		}
	}
	...
	private void printOperations() {
		...
		if(Objects.isNull(curProject)) {
			System.out.println("\nYou aren't working with a project");
		} else {
